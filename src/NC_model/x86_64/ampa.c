...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 AMPA /home/kanisorn/Downloads/147867/CA3Atrophy/ampa.mod\n");
...
/*CVODE*/
 ...
 static int states (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) { {
   evaluateC ( _threadargs_ ) ;
    R = R + (1. - exp(dt*(( Alpha * C )*( ( ( - 1.0 ) ) ) - ( Beta )*( 1.0 ))))*(- ( ( ( Alpha )*( C ) )*( ( 1.0 ) ) ) / ( ( ( Alpha )*( C ) )*( ( ( - 1.0 ) ) ) - ( Beta )*( 1.0 ) ) - R) ;
   }
  return 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kanisorn/Downloads/147867/CA3Atrophy/ampa.mod";
static const char* nmodl_file_text = 
